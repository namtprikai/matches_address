...
def gradio_interface(tatemono_file, water_supply_file, shp_file, ken, sikuchoson, join_option, output_format):
    """
    ...
    # データ処理を実行
    output_path, join_ratio = process_data(tatemono_file.name, water_supply_file.name, shp_file.name, ken, sikuchoson, option, output_format)
    # 結果を返す
