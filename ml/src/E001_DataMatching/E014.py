...
def embedding_address(main_csv: io.BytesIO, sub_csv: io.BytesIO, main_column: str, sub_column: str, merge_base: str, ngram: int = 2, threshold: float = 0.5, batch_size: int = 1000, output_path:str = None ) -> Tuple[str, str]:   
    """
    住所名寄せ処理を行う
